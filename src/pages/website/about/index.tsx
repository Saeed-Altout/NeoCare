          ...
          <div className="max-w-4xl mx-auto text-center space-y-8">
            <div className="space-y-4">
              ...
              <p className="text-xl text-muted-foreground leading-relaxed max-w-3xl mx-auto">
                Founded with a mission to transform neonatal healthcare through
                innovative technology, NeoCare is dedicated to improving
            ...
            <div className="flex items-center justify-center space-x-8 pt-4">
              ...
              <p className="text-sm text-muted-foreground">
                Rated <span className="font-semibold">4.9/5</span> by healthcare
                professionals
              </p>
            </div>
          </div>
            ...
            <Card className="text-center">
              ...
              <CardContent>
                <p className="text-muted-foreground text-lg">
                  ...
                  safety in every device we manufacture, backed by comprehensive
        ...
        <div className="container mx-auto px-4">
          <div className="text-center space-y-4 mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              From concept to global impact, our journey reflects our commitment
              to advancing neonatal healthcare technology.
            </p>
          </div>
