              ...
              <div className="space-y-8">
                <div className="space-y-4">
                  ...
                  <p className="text-xl text-muted-foreground leading-relaxed">
                    Revolutionary LED-based phototherapy system designed for
                    safe and effective treatment of neonatal jaundice with
                ...
                <Card className="text-center">
                  ...
                  <CardContent>
                    <p className="text-muted-foreground">
                      ...
                      solutions that improve outcomes for newborns with
                      jaundice.
                    </p>
                  </CardContent>
                </Card>
                ...
                <Card className="text-center">
                  ...
                  <CardContent>
                    <p className="text-muted-foreground">
                      ...
                      technologies worldwide, improving lives one baby at a
                      time.
                    </p>
                  </CardContent>
                </Card>
